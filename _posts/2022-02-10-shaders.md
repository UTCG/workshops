...
We can make other colours by putting different values into the R/G/B parts of `col`, e.g. <div style="color:#FF8080">`red = vec3(1., .5, .5)`</div> or <div style="color:#4080FF">`blue = vec3(.25, .5, 1.)`</div>.
